var ansispan = function (str) {
  ...
  Object.keys(ansispan.backgroundColors).forEach(function (ansi) {
    var span = '<span style="background-color: ' + ansispan.backgroundColors[ansi] + '">';

    //
    // `\043[Xm` == `\043[0;Xm` sets background color to `X`.
    //
